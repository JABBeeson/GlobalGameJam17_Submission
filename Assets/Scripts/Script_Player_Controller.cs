...
public class Script_Player_Controller : MonoBehaviour {
    ...
    public script_camera camScript;
    ...
    void Awake()
    {
        ...
        camScript = cam.GetComponent<script_camera>();
        
        index = script_Manager.Instance.NewTeam(gameObject);
        startindex = index;
    ...
    private void Shoot(float shake, float recoil)
    {
        ...
        for (int i = 0; i < shotCount; i++)
        {
            ...
            bullet.GetComponentInChildren<script_Shot>().team = index;
        }       
