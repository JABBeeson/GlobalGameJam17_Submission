...
public class Script_BoidsBehaviour : MonoBehaviour {
    ...
    private void OnCollisionEnter(Collision collision)
    {
        ...
        {
            if (collision.gameObject.GetComponent<Script_BoidsBehaviour>().group.GetTeam() != group.GetTeam())
                collision.gameObject.GetComponent<script_enemyInteractions>().Damage(1);
        }
    }
}
